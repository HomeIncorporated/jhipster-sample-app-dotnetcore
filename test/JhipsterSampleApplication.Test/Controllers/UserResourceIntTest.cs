...
namespace MyCompany.Test.Controllers {
    public class UserResourceIntTest {
        ...
        public async Task CreateUser()
        {
            ...
            var response = await _client.PostAsync("/api/users", TestUtil.ToJsonContent(managedUserVM));
        ...
        public void TestUserDtoToUser()
        {
            ...
            var user = _userMapper.UserDtoToUser(userDto);
        ...
        public async Task UpdateUser()
        {
            ...
            var response = await _client.PutAsync("/api/users", TestUtil.ToJsonContent(managedUserVM));
            response.StatusCode.Should().Be(HttpStatusCode.OK);
